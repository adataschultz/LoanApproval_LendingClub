...
path = r'D:\Loan-Status\Python\Models\ML\Linear\GridSearchCV\Model_PKL'
os.chdir(path)
...
###############################################################################
# Set path for ML results
path = r'D:\Loan-Status\Python\Models\ML\Linear\GridSearchCV\Model_Explanations'
os.chdir(path)
...
with open('D:\Loan-Status\Python\Models\ML\Linear\GridSearchCV\Model_Explanations\LassoMod_US_HPO_WeightsFeatures.htm',
          'wb') as f:
    f.write(html_obj.data.encode('UTF-8'))

# Open the stored feature weights HTML file
url = r'D:\Loan-Status\Python\Models\ML\Linear\GridSearchCV\Model_Explanations\LassoMod_US_HPO_WeightsFeatures.htm'
...
with open('D:\Loan-Status\Python\Models\ML\Linear\GridSearchCV\Model_Explanations\LassoMod_US_HPO_Prediction.htm',
          'wb') as f:
    f.write(html_obj2.data.encode('UTF-8'))

# Open the show prediction stored HTML file
url2 = r'D:\Loan-Status\Python\Models\ML\Linear\GridSearchCV\Model_Explanations\LassoMod_US_HPO_Prediction.htm'
...
# Write feature weights html object to a file 
with open('D:\Loan-Status\Python\Models\ML\Linear\GridSearchCV\Model_Explanations\LassoMod_US_HPO_SMOTE_WeightsFeatures.htm',
          'wb') as f:
    f.write(html_obj.data.encode('UTF-8'))

# Open the stored feature weights HTML file
url = r'D:\Loan-Status\Python\Models\ML\Linear\GridSearchCV\Model_Explanations\LassoMod_US_HPO_SMOTE_WeightsFeatures.htm'
webbrowser.open(url, new=2)
...
# Write show prediction html object to a file 
with open('D:\Loan-Status\Python\Models\ML\Linear\GridSearchCV\Model_Explanations\LassoMod_US_HPO_SMOTE_Prediction.htm',
          'wb') as f:
    f.write(html_obj2.data.encode('UTF-8'))

# Open the stored show prediction HTML file
url2 = r'D:\Loan-Status\Python\Models\ML\Linear\GridSearchCV\Model_Explanations\LassoMod_US_HPO_SMOTE_Prediction.htm'
webbrowser.open(url2, new=2)
