...
path = r'D:\Loan-Status\Python\ML\Catboost\trialOptions'
os.chdir(path)
...
# Set path for ML results
path = r'D:\Loan-Status\Python\ML\Catboost\Model_PKL'
os.chdir(path)
...
# Set path for ML results
path = r'D:\Loan-Status\Python\ML\Catboost\bayesParams'
os.chdir(path)
...
# Set path for ML results
path = r'D:\Loan-Status\Python\ML\Catboost\Model_Explanations'
os.chdir(path)
...
with open(r'D:\Loan-Status\Python\ML\Catboost\Model_Explanations\best_bayes_Upsampling_100_WeightsFeatures.htm',
          'wb') as f:
    f.write(html_obj.data.encode("UTF-8"))

# Open the stored feature weights HTML file
url = r'D:\Loan-Status\Python\ML\Catboost\Model_Explanations\Catboost\best_bayes_Upsampling_100_WeightsFeatures.htm'
...
###############################################################################
# Set path for ML results
path = r'D:\Loan-Status\Python\ML\Catboost\bestBayes_WeightsExplain'
os.chdir(path)
...
exp.to_csv('best_bayes_Upsampling_100_WeightsExplain.csv',
...
# Write feature weights html object to a file 
with open(r'D:\Loan-Status\Python\ML\Catboost\Model_Explanations\best_bayes_SMOTE_100_WeightsFeatures.htm',
          'wb') as f:
    f.write(html_obj.data.encode("UTF-8"))

# Open the stored feature weights HTML file
url = r'D:\Loan-Status\Python\ML\Catboost\Model_Explanations\best_bayes_SMOTE_100_WeightsFeatures.htm'
webbrowser.open(url, new=2)
...
# Write processed data to csv
exp.to_csv('best_bayes_SMOTE_100_WeightsExplain.csv',
           index=False, encoding='utf-8-sig')
...
# Write feature weights html object to a file 
with open(r'D:\Loan-Status\Python\ML\Catboost\Model_Explanations\best_bayes_Upsampling_300_WeightsFeatures.htm',
          'wb') as f:
    f.write(html_obj.data.encode("UTF-8"))

# Open the stored feature weights HTML file
url = r'D:\Loan-Status\Python\ML\Catboost\Model_Explanations\Catboost\best_bayes_Upsampling_300_WeightsFeatures.htm'
webbrowser.open(url, new=2)
...
# Write processed data to csv
exp.to_csv('best_bayes_Upsampling_300_WeightsExplain.csv',
           index=False, encoding='utf-8-sig')
...
# Write feature weights html object to a file 
with open(r'D:\Loan-Status\Python\ML\Catboost\Model_Explanations\best_bayes_SMOTE_300_WeightsFeatures.htm',
          'wb') as f:
    f.write(html_obj.data.encode("UTF-8"))

# Open the stored feature weights HTML file
url = r'D:\Loan-Status\Python\ML\Catboost\Model_Explanations\best_bayes_SMOTE_300_WeightsFeatures.htm'
webbrowser.open(url, new=2)
...
# Write processed data to csv
exp.to_csv('best_bayes_SMOTE_300_WeightsExplain.csv',
           index=False, encoding='utf-8-sig')
...
# Write feature weights html object to a file 
with open(r'D:\Loan-Status\Python\ML\Catboost\Model_Explanations\best_bayes_Upsampling_500_WeightsFeatures.htm',
          'wb') as f:
    f.write(html_obj.data.encode("UTF-8"))

# Open the stored feature weights HTML file
url = r'D:\Loan-Status\Python\ML\Catboost\Model_Explanations\Catboost\best_bayes_Upsampling_500_WeightsFeatures.htm'
webbrowser.open(url, new=2)
...
# Write processed data to csv
exp.to_csv('best_bayes_Upsampling_500_WeightsExplain.csv',
           index=False, encoding='utf-8-sig')
...
# Write feature weights html object to a file 
with open(r'D:\Loan-Status\Python\ML\Catboost\Model_Explanations\best_bayes_SMOTE_500_WeightsFeatures.htm',
          'wb') as f:
    f.write(html_obj.data.encode("UTF-8"))

# Open the stored feature weights HTML file
url = r'D:\Loan-Status\Python\ML\Catboost\Model_Explanations\best_bayes_SMOTE_500_WeightsFeatures.htm'
webbrowser.open(url, new=2)
...
# Write processed data to csv
exp.to_csv('best_bayes_SMOTE_500_WeightsExplain.csv',
           index=False, encoding='utf-8-sig')
