...
path = r'D:\Loan-Status\Python\ML\NB\Model_PKL'
os.chdir(path)
...
###############################################################################
# Set path for ML results
path = r'D:\Loan-Status\Python\ML\NB\Model_Explanations'
os.chdir(path)
...
with open(r'D:\Loan-Status\Python\NB\Model_Explanations\NB_US_HPO_WeightsFeatures.htm',
          'wb') as f:
    f.write(html_obj.data.encode("UTF-8"))

# Open the stored feature weights HTML file
url = r'D:\Loan-Status\Python\NB\Model_Explanations\NB_US_HPO_WeightsFeatures.htm'
...
###############################################################################
# Set path for ML results
path = r'D:\Loan-Status\Python\ML\NB\bestBayes_WeightsExplain'
os.chdir(path)
...
exp.to_csv('NB_US_HPO_WeightsExplain.csv',
...
# Write feature weights html object to a file 
with open(r'D:\Loan-Status\Python\NB\Model_Explanations\NB_US_HPO_SMOTE_WeightsFeatures.htm',
          'wb') as f:
    f.write(html_obj.data.encode("UTF-8"))

# Open the stored feature weights HTML file
url = r'D:\Loan-Status\Python\NB\Model_Explanations\NB_US_HPO_SMOTE_WeightsFeatures.htm'
webbrowser.open(url, new=2)
...
# Write processed data to csv
exp.to_csv('NB_US_HPO_SMOTE_WeightsExplain.csv',
           index=False, encoding='utf-8-sig')
...
# Write feature weights html object to a file 
with open(r'D:\Loan-Status\Python\NB\Model_Explanations\NB_SMOTE_HPO_WeightsFeatures.htm',
          'wb') as f:
    f.write(html_obj.data.encode("UTF-8"))

# Open the stored feature weights HTML file
url = r'D:\Loan-Status\Python\NB\Model_Explanations\NB_SMOTE_HPO_WeightsFeatures.htm'
webbrowser.open(url, new=2)
...
# Write processed data to csv
exp.to_csv('NB_SMOTE_HPO_WeightsExplain.csv', index=False, encoding='utf-8-sig')
...
# Write feature weights html object to a file 
with open(r'D:\Loan-Status\Python\NB\Model_Explanations\NB_SMOTE_HPO_US_WeightsFeatures.htm',
          'wb') as f:
    f.write(html_obj.data.encode("UTF-8"))

# Open the stored feature weights HTML file
url = r'D:\Loan-Status\Python\NB\Model_Explanations\NB_SMOTE_HPO_US_WeightsFeatures.htm'
webbrowser.open(url, new=2)
