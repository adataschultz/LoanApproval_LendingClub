...
path = r'D:\Loan-Status\Python\ML\Xgboost\trialOptions'
os.chdir(path)
...
# Set path for ML results
path = r'D:\Loan-Status\Python\ML\Xgboost\Model_PKL'
os.chdir(path)
...
# Set path for ML results
path = r'D:\Loan-Status\Python\ML\Xgboost\bayesParams'
os.chdir(path)
...
###############################################################################
# Set path for ML results
path = r'D:\Loan-Status\Python\ML\Xgboost\Model_Explanations'
os.chdir(path)
...
with open(r'D:\Loan-Status\Python\ML\Xgboost\Model_Explanations\best_bayes_Upsampling_100_WeightsFeatures.htm',
          'wb') as f:
    f.write(html_obj.data.encode("UTF-8"))

# Open the stored feature weights HTML file
url = r'D:\Loan-Status\Python\ML\Xgboost\Model_Explanations\best_bayes_Upsampling_100_WeightsFeatures.htm'
...
###############################################################################
# Set path for ML results
path = r'D:\Loan-Status\Python\ML\Xgboost\bestBayes_WeightsExplain'
os.chdir(path)
...
# Write feature weights html object to a file 
with open(r'D:\Loan-Status\Python\ML\Xgboost\Model_Explanations\best_bayes_SMOTE_100_WeightsFeatures.htm',
          'wb') as f:
    f.write(html_obj.data.encode("UTF-8"))

# Open the stored feature weights HTML file
url = r'D:\Loan-Status\Python\ML\Xgboost\Model_Explanations\best_bayes_SMOTE_100_WeightsFeatures.htm'
webbrowser.open(url, new=2)
...
# Write feature weights html object to a file 
with open(r'D:\Loan-Status\Python\ML\Xgboost\Model_Explanations\best_bayes_Upsampling_300_WeightsFeatures.htm',
          'wb') as f:
    f.write(html_obj.data.encode("UTF-8"))

# Open the stored feature weights HTML file
url = r'D:\Loan-Status\Python\ML\Xgboost\Model_Explanations\best_bayes_Upsampling_300_WeightsFeatures.htm'
webbrowser.open(url, new=2)
...
# Write feature weights html object to a file 
with open(r'D:\Loan-Status\Python\ML\Xgboost\Model_Explanations\best_bayes_SMOTE_300_WeightsFeatures.htm',
          'wb') as f:
    f.write(html_obj.data.encode("UTF-8"))

# Open the stored feature weights HTML file
url = r'D:\Loan-Status\Python\ML\Xgboost\Model_Explanations\best_bayes_SMOTE_300_WeightsFeatures.htm'
webbrowser.open(url, new=2)
