...
path = r'D:\Loan-Status\Python\ML\lightGBM\trialOptions'
os.chdir(path)
...
# Set path for ML results
path = r'D:\Loan-Status\Python\ML\lightGBM\bayesParams'
os.chdir(path)
...
###############################################################################
# Set path for ML results
path = r'D:\Loan-Status\Python\ML\lightGBM\Model_Explanations'
os.chdir(path)
...
###############################################################################
# Set path for ML results
path = r'D:\Loan-Status\Python\ML\lightGBM\bestBayes_WeightsExplain'
os.chdir(path)
...
# Write processed data to csv
exp.to_csv('best_bayes_Upsampling_GBDT_300_WeightsExplain.csv',
           index=False, encoding='utf-8-sig')
